                ...
                <jet-dropdown align="right" width="48">
                  ...
                  <template #content>
                    ...
                    <form @submit.prevent="logout">
                      <jet-dropdown-link tag="button"> Log Out </jet-dropdown-link>
                    </form>
                  </template>
                </jet-dropdown>
              </div>
          ...
          <div v-if="$page.props.user" class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
              ...
              <form method="POST" @submit.prevent="logout">
                <jet-responsive-nav-link tag="button"> Log Out </jet-responsive-nav-link>
              </form>
            </div>
          </div>
        </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    return { route, showingNavigationDropdown, logout };
  },
});
</script>
